...
public class Walker {
     ...
     */
    private goblinkiller.util.Walker.Type getType(String s) {
        if (s.matches("(?i)((.*)?door)")) {
            return goblinkiller.util.Walker.Type.DOOR;
        } else if (s.matches("(?i)(gate(.*)?)")) {
            return goblinkiller.util.Walker.Type.GATE;
        } else if (s.equalsIgnoreCase("ladder")) {
            return goblinkiller.util.Walker.Type.LADDER;
        }
        return goblinkiller.util.Walker.Type.TEAPOT;
    }
